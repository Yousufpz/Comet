  ...
  return (
    <StyledWrapper>
      <div className="outer">
        ...
        <div className="card">
          <div className="ray" />
          <div className="text">Powerful banking. Simplified finances.</div>
          <div className="description">Apply in 10 minutes for online business banking that transforms how you operate</div>
